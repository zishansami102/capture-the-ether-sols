...
before(async () => {
    ...
    contract = await chFactory.attach(`0x30708EF05245717e4C785B5838d711576DdB3928`);
  });
  
  it("ch10", async function () {
    const solFactory = await ethers.getContractFactory("TokenSaleChallengeSolution");
