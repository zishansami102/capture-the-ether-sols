...
before(async () => {
    ...
    contract = factory.attach(`0x5756b4Fce2844Ae697a070E8e4938ba675b6bDDa`)
  });
  
  it("ch5", async function () {
    ...
    const tx = await contract.guess(num, {value:ethers.utils.parseEther("1.0")});
    await tx.wait()
